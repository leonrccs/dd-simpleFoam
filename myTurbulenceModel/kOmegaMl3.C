...
void kOmegaMl3<BasicTurbulenceModel>::correctNut()
{
    this->nut_ = k_/omega_;
...
template<class BasicTurbulenceModel>
kOmegaMl3<BasicTurbulenceModel>::kOmegaMl3
(
...
template<class BasicTurbulenceModel>
bool kOmegaMl3<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaMl3<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    (
        ...
        gamma_mix_it_*(-2)*k_*((b_ml)&&tgradU())
...
template<class BasicTurbulenceModel>
tmp<fvVectorMatrix>kOmegaMl3<BasicTurbulenceModel>::divDevRhoReff
(
    volVectorField& U
) const
{
    ...
    // Data driven b incorporated
     ...
     + gamma_mix_it_*fvc::div(2*this->k_ * (b_ml))
